...
%token PLUS MINUS TIMES DIV LB RB LS RS LP RP ASSIGN SEMI COMMA TYPE VOID MOD POWER (* prob4: ADD MOD*)(*prob6: ADD POWER*)
%type <Ast.stmt> prog
...
dec  : ty ids SEMI   { List.map (fun x -> VarDec ($1,x, None)) $2 } (*prob5: add None*)
     | ty ID ASSIGN expr SEMI { [VarDec ($1, $2, Some $4)] } (* prob5: add rule*)
...
expr : NUM { IntExp $1  }
     ...
     | expr MOD expr { CallFunc ("-", [$1; CallFunc ("*", [CallFunc ("/", [$1; $3]); $3])])} (* prob4:expr mod rule*)
